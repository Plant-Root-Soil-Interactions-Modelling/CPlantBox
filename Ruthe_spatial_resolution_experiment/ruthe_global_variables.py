...
class RutheConfig:
    ...
    NUMBER_OF_ROWS_SOIL_CORE: int = (
        10  # number of plant rows in the field considered in soil core simulation
    )
    NUMBER_OF_PLANTS_PER_ROW_SOIL_CORE: int = (
        20  # number of plants per row in the field considered in soil core simulation
    )
    ...
    NUMBER_OF_SOIL_CORE_SAMPLES: int = 2  # number of virtual soil cores sampled per run

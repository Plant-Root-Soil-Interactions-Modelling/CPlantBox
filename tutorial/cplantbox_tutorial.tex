...
\input{latex/structural_organs.tex}

\subsection{Seed} \label{ssec:seed}
\input{latex/structural_seed.tex}

\subsection{Stem} \label{ssec:stem}
\input{latex/structural_stem.tex}

\subsection{Leaf} \label{ssec:leaf}
\input{latex/structural_leaf.tex}

\subsection{Root} \label{ssec:root}
\input{latex/structural_root.tex}
...
\input{latex/contributing_codingstyle.tex}

\subsection{Todos} \label{ssec:todos}
\input{latex/contributing_todos.tex}

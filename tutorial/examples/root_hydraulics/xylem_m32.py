...
rx_a = r.solve_dirichlet(0.0, p0, [p_s], cells=True)
print("Transpiration", r.get_transpiration(0.0, rx_a, [p_s], cells=True), "cm3/day")
...
param.plot_conductivities(axes_ind=[1], lateral_ind=[2, 3])
param.write_parameters("m32")

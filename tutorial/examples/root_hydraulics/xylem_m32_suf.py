...
def suf_krs(r, param):
    ...
    r.ms.setRectangularGrid(pb.Vector3d(min_b[0], min_b[1], min_b[2]), pb.Vector3d(max_b[0], max_b[1], max_b[2]), pb.Vector3d(cell_number[0], cell_number[1], cell_number[2]), False)
...
print("cell -0.5 cm", r.ms.soil_index(0.0, 0.0, -0.5))  # first cell is at position 14

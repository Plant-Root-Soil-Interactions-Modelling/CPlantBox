...
def err(fitparams):
    ...
    np.savetxt("RLDs/p1_virt_rm_std_"+mat+"_"+den+".txt",rmstd,fmt='%.2f')

    #compare measured and simulated core RLDs 
    with open("RLDs/p1_measured_RLD_std_"+mat+"_"+den+".txt") as f: #read in measured RLDs
...
set_all_sd(rs) #set the std zero
rs.writeParameters("rootsystem_params/p1_Optimization_"+mat+".xml")

...
p_s = np.arange(0, -10000, -100) #cm
N = np.arange(0.1, 6, 0.5) #%8
#print(RH, Q, TairC, p_s)
...
logfile = open('leuning6gps.txt', "w")
logfile.write('input parameters: ')
logfile.write(repr(r.Param))
logfile.write('input variables: \n'+repr(variables))
logfile.write('\nE (cm3/d) matrix: \n' +repr(results))
logfile.write('\nAn (μmol CO2 m-2 s-1) matrix: \n' +repr(resultsAn))
logfile.write('\nVc (μmol CO2 m-2 s-1) matrix: \n' +repr(resultsVc))
logfile.write('\nVj (μmol CO2 m-2 s-1) matrix: \n' +repr(resultsVj))
logfile.write('\ngco2 (mol CO2 m-2 s-1) matrix: \n' +repr(resultsgco2))
logfile.write('\nci/cs (-) matrix: \n' +repr(resultscics))


fig, axs = plt.subplots(2,2)
axs[0, 0].plot(variables[3], resultsAn[3])
axs[0, 0].set(xlabel='Ψ at root collar (cm)', ylabel='mean An (μmol CO2 m-2 s-1)')
axs[1, 0].plot(variables[3], resultsVc[3], 'tab:red')
axs[1, 0].set(xlabel='Ψ at root collar (cm)', ylabel='mean Vc (μmol CO2 m-2 s-1)')
axs[0, 1].plot(variables[3], resultsVj[3], 'tab:brown')
axs[0, 1].set(xlabel='Ψ at root collar (cm)', ylabel='mean Vj (μmol CO2 m-2 s-1)')
axs[1, 1].plot(variables[3], resultsgco2[3], 'tab:brown')
axs[1, 1].set(xlabel='Ψ at root collar (cm)', ylabel='mean gco2 mean Vc (μmol CO2 m-2 s-1)')
plt.show()
fig, axs = plt.subplots(2,2)
axs[0, 0].plot(variables[3], results[3])
axs[0, 0].set(xlabel='Ψ at root collar (cm)', ylabel='E')
axs[0, 1].plot(variables[3], resultsfw[3], 'tab:brown')
axs[0, 1].set(xlabel='Ψ at root collar (cm)', ylabel='fw')
axs[1, 0].plot(variables[3], resultspl[3], 'tab:brown')
axs[1, 0].set(xlabel='Ψ at root collar (cm)', ylabel='pl')
axs[1, 1].plot(variables[3], resultscics[3], 'tab:brown')
axs[1, 1].set(xlabel='Ψ at root collar (cm)', ylabel='ci/cs (-)')
plt.show()
"""
# plot results 
fig, axs = plt.subplots(2,2, sharey=True)
axs[0, 0].plot(variables[0], results[0])
axs[0, 0].set(xlabel='Q mol quanta m-2 s-1', ylabel='E (cm3/d)')
axs[0, 1].plot(variables[1], results[1], 'tab:blue')
axs[0, 1].set(xlabel='RH at 20°C (%)')
axs[1, 0].plot(variables[2], results[2], 'tab:red')
axs[1, 0].set(xlabel='Tair (°C)', ylabel='E (cm3/d)')
axs[1, 1].plot(variables[3], results[3], 'tab:brown')
axs[1, 1].set(xlabel='wat pot at root collar (cm)')
plt.show()
fig, axs = plt.subplots(2,2, sharey=True)
axs[0, 0].plot(variables[0], resultsAn[0])
axs[0, 0].set(xlabel='Q mol quanta m-2 s-1', ylabel='An (mol CO2 m-2 s-1)')
axs[0, 1].plot(variables[1], resultsAn[1], 'tab:blue')
axs[0, 1].set(xlabel='RH at 20°C (%)')
axs[1, 0].plot(variables[2], resultsAn[2], 'tab:red')
axs[1, 0].set(xlabel='Tair (°C)', ylabel='An (mol CO2 m-2 s-1)')
axs[1, 1].plot(variables[3], resultsAn[3], 'tab:brown')
axs[1, 1].set(xlabel='wat pot at root collar (cm)')
plt.show()
fig, axs = plt.subplots(2,2, sharey=True)
axs[0, 0].plot(variables[0], resultsVc[0])
axs[0, 0].set(xlabel='Q mol quanta m-2 s-1', ylabel='Vc (mol CO2 m-2 s-1)')
axs[0, 1].plot(variables[1], resultsVc[1], 'tab:blue')
axs[0, 1].set(xlabel='RH at 20°C (%)')
axs[1, 0].plot(variables[2], resultsVc[2], 'tab:red')
axs[1, 0].set(xlabel='Tair (°C)', ylabel='Vc (mol CO2 m-2 s-1)')
axs[1, 1].plot(variables[3], resultsVc[3], 'tab:brown')
axs[1, 1].set(xlabel='wat pot at root collar (cm)')
plt.show()
fig, axs = plt.subplots(2,2, sharey=True)
axs[0, 0].plot(variables[0], resultsVj[0])
axs[0, 0].set(xlabel='Q mol quanta m-2 s-1', ylabel='Vj (mol CO2 m-2 s-1)')
axs[0, 1].plot(variables[1], resultsVj[1], 'tab:blue')
axs[0, 1].set(xlabel='RH at 20°C (%)')
axs[1, 0].plot(variables[2], resultsVj[2], 'tab:red')
axs[1, 0].set(xlabel='Tair (°C)', ylabel='Vj (mol CO2 m-2 s-1)')
axs[1, 1].plot(variables[3], resultsVj[3], 'tab:brown')
axs[1, 1].set(xlabel='wat pot at root collar (cm)')
plt.show()
fig, axs = plt.subplots(2,2, sharey=True)
axs[0, 0].plot(variables[0], resultsgco2[0])
axs[0, 0].set(xlabel='Q mol quanta m-2 s-1', ylabel='gco2 (mol CO2 m-2 s-1)')
axs[0, 1].plot(variables[1], resultsgco2[1], 'tab:blue')
axs[0, 1].set(xlabel='RH at 20°C (%)')
axs[1, 0].plot(variables[2], resultsgco2[2], 'tab:red')
axs[1, 0].set(xlabel='Tair (°C)', ylabel='gco2 (mol CO2 m-2 s-1)')
axs[1, 1].plot(variables[3], resultsgco2[3], 'tab:brown')
axs[1, 1].set(xlabel='wat pot at root collar (cm)')
plt.show()
plt.show()

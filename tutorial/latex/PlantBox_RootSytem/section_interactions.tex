...
\lstinputlisting[firstline=1,lastline=50, language=Python, caption=Example 5c]{../../examples/python/example5c_insertionangle.py}

\subsection{Cange of lateral emergence probability} \label{sec:branching}

\lstinputlisting[firstline=1,lastline=50, language=Python, caption=Example 5d]{../../examples/python/example5d_branching.py}

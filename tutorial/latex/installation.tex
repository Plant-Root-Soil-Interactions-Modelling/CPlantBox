...
\istinline{sudo apt-get install curl}\\
...
\istinline{bash anaconda.sh}\\
\istinline{source ~/.bashrc}\\
...
\lstinline{make}\\
(If building CPlantBox on the IBG-3 cluster, two lines in the file \lstinline{\textbf{CPlantBox}/CMakeLists.txt} need to be outcommented before:\\ 

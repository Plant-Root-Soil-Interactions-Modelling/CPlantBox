...
exu_rates = [np.array([0.001, 0.001,0.00055,0.00039,0.00045]),
...
for i in range(0,len(names)): 
    ...
    if i <=1:
        ...
        mean = data["Total exudation"].values*g_per_mol_C*24/10**3 #mmol/plant/h--> mg/plant/d
        SE = data['Total exudation SE'].values*g_per_mol_C*24/10**3 

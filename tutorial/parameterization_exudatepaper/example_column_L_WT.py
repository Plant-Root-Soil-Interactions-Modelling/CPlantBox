...
name = "RS_optimized_column_L_WT"
rs.readParameters(path + name + ".xml")

#data
times_ = [42, 63, 98, 154]
real_length = np.array([2091, 19076, 77627, 76958])
real_length_SE = np.array([182, 2362, 2869, 8182])
real_diam = np.array([0.37, 0.32, 0.33, 0.30])
real_diam_SE = np.array([0.005, 0.009, 0.01, 0.005])

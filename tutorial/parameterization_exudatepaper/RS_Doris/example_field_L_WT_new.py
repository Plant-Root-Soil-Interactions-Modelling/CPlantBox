...
path = "rootsystem/"
name = "RS_optimized_field_L_WT_new"
rs.readParameters(path + name + ".xml")

#data
times_ = [42, 63, 98, 154]
real_length = np.array([1859, 14000, 70760, 60950])
real_length_SE = np.array([273, 1620, 2404, 4010])
real_diam = np.array([0.25, 0.23, 0.20, 0.19])
real_diam_SE = np.array([0.014, 0.008, 0.008, 0.010]) 

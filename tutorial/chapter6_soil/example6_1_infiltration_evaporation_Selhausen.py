...
# Define Mualem van Genuchten parameters for Selhausen soil profile accordinf to Bauer et al. (2011, table 3, \url{https://doi.org/10.1007/s10533-011-9583-1}) |\label{l61ies:genuchten_a}|
...
# define output times
sel_idx=np.searchsorted(soil_times, [0., 0.2, 0.5, 1.,1.2, 1.5,2.])

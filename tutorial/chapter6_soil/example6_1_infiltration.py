...
N = 199
s.createGrid([-5., -5., -200.], [5., 5., 0.], [1, 1, N])  # [cm] N   |\label{l61i:grid}|
s.setHomogeneousIC(-400.)  # cm pressure head    |\label{l61i:ic}|
...
s.ddt = 1.e-5  # initial dumux time step [days]  |\label{l61i:initialDT}|

top_ind = s.pick([0., 0., -0.5])  # |\label{l61i:picker_a}|
bot_ind = s.pick([0., 0., -199.5])  # |\label{l61i:picker_b}|

...
<<<<<<< HEAD
    param.setKrTables([kr0[:, 1], kr0[:, 1], kr1[:, 1], kr1[:, 1]], [kr0[:, 0], kr0[:, 0], kr1[:, 0], kr1[:, 0]])
    ...
    param.setKxTables([kx0[:, 1], kx0[:, 1], kx1[:, 1], kx1[:, 1]], [kx0[:, 0], kx0[:, 0], kx1[:, 0], kx1[:, 0]])
=======
...
<<<<<<< HEAD
r = HydraulicModel_Doussan("RootSystem.rsml", param, cached = True)  # or HydraulicModel_Doussan, HydraulicModel_Meunier
krs_ad, suf_ad, krs_bd, suf_bd = suf_krs(r, param)
r = HydraulicModel_Meunier("RootSystem.rsml", param, cached = True)  # or HydraulicModel_Doussan, HydraulicModel_Meunier
=======
file_name = "../../../dumux-rosi/grids/RootSystem.rsml"
r = HydraulicModel_Doussan(file_name, param, cached = True)  # or HydraulicModel_Doussan, HydraulicModel_Meunier
krs_ad, suf_ad, krs_bd, suf_bd = suf_krs(r, param)
r = HydraulicModel_Meunier(file_name, param, cached = True)  # or HydraulicModel_Doussan, HydraulicModel_Meunier
>>>>>>> master

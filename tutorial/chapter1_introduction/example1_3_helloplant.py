#%%
import sys;sys.path.append("./dumux/CPlantBox/src/")  # |\label{l13:path}|
...
path = "./dumux/CPlantBox/modelparameter/structural/plant/"
name = "fspm2023"
...
plant.write("./dumux/CPlantBox/tutorial/chapter1_introduction/results/example_plant.vtp")  # using polylines |\label{l13:write_poly}|

ana = pb.SegmentAnalyser(plant)
ana.write("./dumux/CPlantBox/tutorial/chapter1_introduction/results/example_plant_segs.vtp")  # using segments |\label{l13:write_segs}|

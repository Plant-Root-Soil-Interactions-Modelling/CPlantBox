...
c = ['r', 'b', 'g', 'c', 'y','m']
marker = ['x', '.']
alts = ['vrld_sl','vrld_2sc', 'vrld_sc_ir', 'vrld_sc_ip', 'vrld_4sc']
labels = ['Soil layer', '2 mixed sc', '2 inter-row sc', '2 inter-plant sc', '4 mixed sc']
annot = ['(i)', '(j)']
...
for i in range(0,len(df_)): 
    ...
    axs[0,i].scatter(1000, 1000, marker = '.', color = c[4], label = labels[4]+', $R^2$ = '+str(np.around(R2[4],2)))

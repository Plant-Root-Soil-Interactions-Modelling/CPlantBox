import sys; sys.path.append("../");sys.path.append("../.."); sys.path.append("../../src/") # |\label{l2_1g:importStart}|
import plantbox as pb
import matplotlib.pyplot as plt  ; import figure_style
import numpy as np
...
ax.scatter(root_tips[:,0], root_tips[:,2],
            c=color[3], label=name[3])    

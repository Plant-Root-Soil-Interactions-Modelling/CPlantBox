# <2_1_2_AStart>
import sys; sys.path.append("../.."); sys.path.append("../../src/") # |\label{l2_1_2:importStart}|
path = "../../modelparameter/structural/plant/"
sys.path.append(path)
import plantbox as pb
import visualisation.vtk_plot as vp
from example1f import template_text # |\label{l2_1_2:importEnd}|
...
rrp = p.getOrganRandomParameter(pb.root)[1] # define laterals of taproot #|\label{l2_1_2:arrayStart1}|
rrp.successorOT = [[2]] 
rrp.successorST = [[2]] 
rrp.successorP  = [[1.0]] 
rrp.successorNo = [1] 
rrp.successorWhere  = [[]] #|\label{l2_1_2:emptywhere}|
...
srp.successorP  = [[1.0]] 
srp.successorNo = [1] 
rrp.successorWhere  = [[]] #|\label{l2_1_2:arrayEnd1}|
...
rrp = p.getOrganRandomParameter(pb.root)[1] # define laterals of taproot #|\label{l2_1_2:arrayStart2}|
...
srp.successorWhere  = [[4.0, 6.0, 8.0], [-3.0]] #|\label{l2_1_2:arrayEnd2}|
...
rrp = p.getOrganRandomParameter(pb.root)[1] # define laterals of taproot #|\label{l2_1_2:arrayStart3}|
rrp.successorOT     = [[2]] 
rrp.successorST     = [[2]] 
rrp.successorP      = [[1.0]] 
rrp.successorNo     = [1] 
...
srp.successorNo     = [4, 1] 
srp.successorWhere  = [[-3.0], [3.0]] #|\label{l2_1_2:arrayEnd3}|

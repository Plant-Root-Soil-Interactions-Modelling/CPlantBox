...
sdf = pb.SDF_PlantBox(np.inf, np.inf, box_max[2] - box_min[2] - 0.1)
...
vp.plot_plant_and_soil(hm.ms, "xylem pressure head (cm)", h_x, s, False, np.array(box_min), np.array(box_max), cell_number, filename, sol_ind=1)

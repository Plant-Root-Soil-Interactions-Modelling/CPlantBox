...
// 1.  g++ -std=c++11 -O3 -fpic -shared -o plantbox.so -Wl,-soname,"plantbox.so" PythonPlant.cpp -I/usr/include/python3.5 -L/home/daniel/boost_1_62_0/stage/lib -lboost_python Debug/ModelParameter.o Debug/Root.o Debug/Plant.o Debug/analysis.o Debug/sdf.o Debug/tropism.o Debug/examples/Exudation/gauss_legendre.o
// 2.  g++ -std=c++11 -O3 -fpic -shared -o plantbox.so -Wl,-soname,"plantbox.so" PythonPlant.cpp -I/usr/include/python3.5 -lboost_python-py35 Debug/ModelParameter.o Debug/Root.o Debug/Plant.o Debug/analysis.o Debug/sdf.o Debug/tropism.o Debug/examples/Exudation/gauss_legendre.o
// 3.  g++ -std=c++11 -O3 -fpic -shared -o plantbox.so -Wl,-soname,"plantbox.so" PythonPlant.cpp -I/usr/include/python3.6 -lboost_python-py36 Debug/ModelParameter.o Debug/Root.o Debug/Plant.o Debug/analysis.o Debug/sdf.o Debug/tropism.o Debug/examples/Exudation/gauss_legendre.o
...
////		.def("setSoil", &Plant::setSoil)
		...
		.def("getOrgans", &Plant::getOrgans, return_value_policy<reference_existing_object>())

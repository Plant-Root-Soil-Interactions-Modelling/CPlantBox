...
PYBIND11_MODULE(plantbox, m) {
    ...
    py::class_<RootSpecificParameter, OrganSpecificParameter, std::shared_ptr<RootSpecificParameter>>(m, "RootSpecificParameter")
     ...
     py::class_<MycorrhizalRootRandomParameter, RootRandomParameter, OrganRandomParameter, std::shared_ptr<MycorrhizalRootRandomParameter>>(m, "MycorrhizalRootRandomParameter")
            .def(py::init<std::shared_ptr<Organism>>())
            .def_readwrite("lmbd", &MycorrhizalRootRandomParameter::lmbd)
            .def_readwrite("lmbds", &MycorrhizalRootRandomParameter::lmbds)
     ...
     py::class_<MycorrhizalRootSpecificParameter, RootSpecificParameter, OrganSpecificParameter, std::shared_ptr<MycorrhizalRootSpecificParameter>>(m, "MycorrhizalRootSpecificParameter")
            ...
            .def_readwrite("lmbd", &MycorrhizalRootSpecificParameter::lmbd)
     ...
     py::class_<HyphaeRandomParameter, OrganRandomParameter, std::shared_ptr<HyphaeRandomParameter>>(m, "HyphaeRandomParameter")
             ...
             .def_readwrite("bs", &HyphaeRandomParameter::bs)
             .def_readwrite("b_prob", &HyphaeRandomParameter::b_prob)
             .def_readwrite("b_prob_s", &HyphaeRandomParameter::b_prob_s)
             ...
             .def_readwrite("tropismT", &HyphaeRandomParameter::tropismT)
             .def_readwrite("tropismN", &HyphaeRandomParameter::tropismN)
             .def_readwrite("tropismS", &HyphaeRandomParameter::tropismS)
     ...
     py::class_<HyphaeSpecificParameter, OrganSpecificParameter, std::shared_ptr<HyphaeSpecificParameter>>(m, "HyphaeSpecificParameter")
             ...
             .def("getK", &HyphaeSpecificParameter::getK)

...
PYBIND11_MODULE(plantbox, m) {
   ...
   py::class_<Photosynthesis, XylemFlux, std::shared_ptr<Photosynthesis>>(m, "Photosynthesis")
    ...
    py::class_<CatmullRomSplineManager, std::shared_ptr<CatmullRomSplineManager>>(m, "CatmullRomSplineManager")
      ...
      .def("getT0", &CatmullRomSplineManager::getT0)
      .def("getT1", &CatmullRomSplineManager::getT1)
      .def("__call__", &CatmullRomSplineManager::operator(), py::arg("x"))
      .def("setY", &CatmullRomSplineManager::setY, py::arg("y"))
      .def("getT", &CatmullRomSplineManager::getT)
      .def("help_lower", &CatmullRomSplineManager::help_lower)
      .def("help_upper", &CatmullRomSplineManager::help_upper)
      .def("getControlPoint", &CatmullRomSplineManager::getControlPoint, py::arg("i"))
      .def("size", &CatmullRomSplineManager::size)
      .def("splineSize", &CatmullRomSplineManager::splineSize)
      .def("getTValues", &CatmullRomSplineManager::getTValues, py::arg("spline"))
      .def("setAlpha", &CatmullRomSplineManager::setAlpha, py::arg("alpha"), py::arg("spline"))
    ;

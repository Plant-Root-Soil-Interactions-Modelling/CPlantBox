...
PYBIND11_MODULE(plantbox, m) {
    ...
    py::class_<Plant, Organism, std::shared_ptr<Plant>>(m, "Plant")
            ...
            .def("initialize", (void (Plant::*)(bool)) &Plant::initialize, py::arg("verbose") = true)
			.def("initializeLB", &Plant::initializeLB, py::arg("basal"), py::arg("shootborne"),  py::arg("verbose") = true)
            .def("initializeDB", &Plant::initializeDB, py::arg("basal"), py::arg("shootborne"),  py::arg("verbose") = true)
	...
	py::class_<MappedPlant, Plant, MappedSegments,  std::shared_ptr<MappedPlant>>(m, "MappedPlant")
			...
			.def("initializeLB", &MappedPlant::initializeLB,  py::arg("basal"), py::arg("shootborne"), py::arg("verbose") = true, py::arg("stochastic") = true)
			.def("initializeDB", &MappedPlant::initializeDB, py::arg("basal"), py::arg("shootborne"),  py::arg("verbose") = true, py::arg("stochastic") = true)

...
public:
     ...
     */
    virtual double getLength(double t, double r, double k, Organ* root) const
     ...
     * \return      root age [day]
     */
    virtual double getAge(double l, double r, double k, Organ* root) const
...
{
public:
    virtual double getLength(double t, double r, double k, Organ* root) const { return std::min(k,r*t); } ///< @see GrowthFunction
    virtual double getAge(double l, double r, double k, Organ* root)  const { return l/r; } ///< @see GrowthFunction
};
...
{
public:
    virtual double getLength(double t, double r, double k, Organ* root) const { return k*(1-exp(-(r/k)*t)); } ///< @see GrowthFunction
    virtual double getAge(double l, double r, double k, Organ* root) const {

...
public:
    ...
    virtual void initialize(std::string mode = "", bool verbose = true) override { initializeLB(4,5, verbose); };
    ...
    void simulate(double dt, double maxinc, std::shared_ptr<ProportionalElongation> se, bool verbose = true); ///< simulates the root system with a maximal overall elongation

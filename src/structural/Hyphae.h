...
public:
    ...
    void setActive(bool active) override {Organ::setActive(active); activeOverriden = true;}; ///< sets the active state of the root, if active is manually overridden, it will not be changed by the simulation, use for testing

 ...
 * @param pni
 */
Organ::Organ(std::shared_ptr<Organism> plant, std::shared_ptr<Organ> parent, int ot, int st, double forDelay,
		 int pni)
: parentNI(pni), plant(plant), parent(parent), id(plant->getOrganIndex()),age(-forDelay),

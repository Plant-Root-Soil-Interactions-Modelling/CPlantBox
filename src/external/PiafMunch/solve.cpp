...
extern double *Q_ST, *Q_Mesophyll, *Q_RespMaint, *Q_Exudation, *Q_Growthtot, *Q_S_ST ;		  // components of vector y as used in diff. system f()...
extern double *Q_ST_dot, *Q_Mesophyll_dot, *Q_Rm_dot, *Q_Exud_dot, *Q_Gtot_dot, *Q_S_ST_dot ; //... and its derivatives.  ;
...
void PhloemFlux::f(double t, double *y, double *y_dot) { // the function to be processed by the solver
	...
	//if delete, lower neq
	Q_S_ST = Q_S_Mesophyll + Nt;//for intermediary compartment between ST and outside. useless (not implemented) delete?
	...
	Q_S_ST_dot = Q_S_Mesophyll_dot + Nt ;//useless, delete?

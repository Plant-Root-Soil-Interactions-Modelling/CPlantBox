...
def add_shoot_conductivity(kr_values, kr_times, kx_values, kx_times):
    ...
    kr_shoot = np.array([[0., 1.e-17], [1.e4, 1.e-17]])  # very small
...
def init_constant_scenario2(r):
    ...
    kr0 = 0.1 * 1.73e-4  # [1/day] # 0-order, transport only
    kx1 = 4.32e-2  # [cm3/day]
    kr1 = 1.73e-4  # [1/day]

    # make an age dependent table from the values
    kr0_ = np.array([[-1e4, -1.e-9], [-1.e-9, 1.e-9], [0., kr0], [1e4, kr0]])  # 0 for negative age
    kr1_ = np.array([[-1e4, -1.e-9], [-1.e-9, 1.e-9], [0., kr1], [1e4, kr1]])  # 0 for negative age
...
def init_dynamic_scenario1(r):
    ...
    kr0_ = np.array([[-1e4, 1.e-9], [-1.e-9, 1.e-9], [0, 1.14e-03], [2, 1.09e-03], [4, 1.03e-03], [6, 9.83e-04], [8, 9.35e-04], [10, 8.90e-04], [12, 8.47e-04], [14, 8.06e-04], [16, 7.67e-04], [18, 7.30e-04], [20, 6.95e-04], [22, 6.62e-04], [24, 6.30e-04], [26, 5.99e-04], [28, 5.70e-04], [30, 5.43e-04], [32, 5.17e-04]])
    kr1_ = np.array([[-1e4, 1.e-9], [-1.e-9, 1.e-9], [0, 4.11e-03], [1, 3.89e-03], [2, 3.67e-03], [3, 3.47e-03], [4, 3.28e-03], [5, 3.10e-03], [6, 2.93e-03], [7, 2.77e-03], [8, 2.62e-03], [9, 2.48e-03], [10, 2.34e-03], [11, 2.21e-03], [12, 2.09e-03], [13, 1.98e-03], [14, 1.87e-03], [15, 1.77e-03], [16, 1.67e-03], [17, 1.58e-03]])

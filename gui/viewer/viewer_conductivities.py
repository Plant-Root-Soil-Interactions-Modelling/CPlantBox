...
def init_constant_scenario2(params):
    ...
    kr0_ = np.array([[-1e4, 0.0], [-1.0e-9, 0.0], [0.0, kr0], [1e4, kr0]])  # 0 for negative age
    kr1_ = np.array([[-1e4, 0.0], [-1.0e-9, 0.0], [0.0, kr1], [1e4, kr1]])  # 0 for negative age
    ...
    params.set_kr_age_dependent(list(kr_values), list(kr_times))  # [cm3/day]
    params.set_kx_age_dependent(list(kx_values), list(kx_times))  # [1/day]
...
def init_constant_scenario_wine(params):
    ...
    kr0_ = np.array([[-1e4, 0.0], [-1.0e-9, 0.0], [0.0, kr0], [1e4, kr0]])  # 0 for negative age
    kr1_ = np.array([[-1e4, 0.0], [-1.0e-9, 0.0], [0.0, kr1], [1e4, kr1]])  # 0 for negative age
    kr2_ = np.array([[-1e4, 0.0], [-1.0e-9, 0.0], [0.0, kr2], [1e4, kr2]])  # 0 for negative age
    kr3_ = np.array([[-1e4, 0.0], [-1.0e-9, 0.0], [0.0, kr3], [1e4, kr3]])  # 0 for negative age

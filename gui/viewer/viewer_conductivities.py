...
def init_dynamic_scenario2(r):
    ...
    print("scenario2: lupine conductivities from Zarebanadkouki et al. (2016)")

    kr_0 = np.array([[-1.e4, 0.], [-0.1, 0.], [0., 1.14e-03], [2, 1.09e-03], [4, 1.03e-03], [6, 9.83e-04], [8, 9.35e-04], [10, 8.90e-04],
    ...
    kr_1 = np.array([[-1e4, 0.], [-0.1, 0.], [0., 4.11e-03], [1, 3.89e-03], [2, 3.67e-03], [3, 3.47e-03], [4, 3.28e-03],
    ...
    kx_0 = np.array([[0., 6.74e-02], [2, 7.48e-02], [4, 8.30e-02], [6, 9.21e-02], [8, 1.02e-01], [10, 1.13e-01],
    ...
    kx_1 = np.array([[0., 4.07e-04], [1, 5.00e-04], [2, 6.15e-04], [3, 7.56e-04], [4, 9.30e-04], [5, 1.14e-03],
    ...
    kr_values = [kr_0[:, 1], kr_1[:, 1], kr_1[:, 1], kr_0[:, 1], kr_0[:, 1], kr_0[:, 1], kr_1[:, 1], kr_1[:, 1], kr_0[:, 1], kr_0[:, 1]]
    kr_times = [kr_0[:, 0], kr_1[:, 0], kr_1[:, 0], kr_0[:, 0], kr_0[:, 0], kr_0[:, 0], kr_1[:, 0], kr_1[:, 0], kr_0[:, 0], kr_0[:, 0]]
    kx_values = [kx_0[:, 1], kx_1[:, 1], kx_1[:, 1], kx_0[:, 1], kx_0[:, 1], kx_0[:, 1], kx_1[:, 1], kx_1[:, 1], kx_0[:, 1], kx_0[:, 1]]
    kx_times = [kx_0[:, 0], kx_1[:, 0], kx_1[:, 1], kx_0[:, 0], kx_0[:, 0], kx_0[:, 0], kx_1[:, 0], kx_1[:, 0], kx_0[:, 0], kx_0[:, 0]]

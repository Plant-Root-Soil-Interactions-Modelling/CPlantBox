...
class TestOrgan(unittest.TestCase):
    ...
    def hand_example(self):
        ...
        self.thumb = pb.Organ(self.human1, self.hand, 0, 0, 4, pb.Vector3d(0., 0., 1.), 0)  # delayedfor 4 days
        self.little_finger = pb.Organ(self.human1, self.hand, 0, 0, 3, pb.Vector3d(0., 0., 1.), 0)  # delayed for 3 days
    ...
    def test_constructors(self):
        ...
        hand = pb.Organ(human1.getOrganIndex(), op, True, True, 0., 15., pb.Vector3d(0., 0., 1.), 0, False, 0) 
        hand.setOrganism(human1)
        # 2. used in simulation (must have parent, since there is no nullptr in Pyhton)
        thumb = pb.Organ(human1, hand, 0, 0, 4, pb.Vector3d(0., 0., 1.), 0)
        little_finger = pb.Organ(human1, hand, 0, 0, 3, pb.Vector3d(0., 0., 1.), 0)
        hand.addChild(thumb)
    ...
    def test_sequential(self):
        ...
        ring = pb.Organ(self.human1, self.thumb, 0, 0, 4, pb.Vector3d(0., 0., 1.), 0)  # add a ring to the thumb

...
class TestStem(unittest.TestCase):
    ...
    def stem_example_rtp(self):
        ...
        p0.name, p0.type, p0.la, p0.lb, p0.nob, p0.ln, p0.r, p0.dx = "tapstem", 1, 1, 10, 20, (89. / 19.), 1, 0.5
        ...
        parentstem = pb.Stem(1, self.param0, True, True, 0., 0., pb.Vector3d(0, 0, -1), 0, 0, False, 0)

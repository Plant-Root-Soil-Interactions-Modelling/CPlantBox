...
def setKrKx_phloem(): #inC
    ...
    r.setPerimeter_st([[Perimeter_s_r0,Perimeter_s_r12,Perimeter_s_r12,Perimeter_s_r0],[Perimeter_s_s,Perimeter_s_s],[Perimeter_s_l]])
...
while simDuration < simMax: 
    ...
    JW_ST = np.array(r.JW_ST) #cm3/d ==> jw * Across

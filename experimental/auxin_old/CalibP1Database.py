...
def toTry():
    ...
    Qs = np.array([500])*1e-6 
    MulimSuc =np.array([1.1])
    GrRatio = np.array([1])# 3, 6, 10 np.array([3, 6, 10]) 
    CarbonCost = np.array([3]) 
    nodeD = np.array([4])
    BerthLim = np.array([0.5])
    kss = np.array([ 1. , 3.,  5.,  10.])
    kaa = np.array([ 1. , 3.,  5.,  10.])
    Klight = np.array([0,0.02])#0.001,0.005,0.01,0.02])

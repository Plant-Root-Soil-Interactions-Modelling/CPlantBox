...
public:
    ...
    Root(Plant* rs, int type, Vector3d pheading, double delay, Organ* parent, double pbl, int pni); ///< typically called by constructor of RootSystem, or Root::createLaterals()
    virtual ~Root();

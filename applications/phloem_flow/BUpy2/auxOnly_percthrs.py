...
def runSim(directoryN_,PRate_ = 4, doVTP = False, 
    ...
    Qmax_ = 1000e-6        
    strPRate_ = str(int(np.round(PRate_*10)))
  ...
  "C_Auxin","AuxinSource","Delta_JA_ST","C_AuxinOut","JAuxin_ST2",
     "activePhloem","activeAuxin","Agn4Phloem","isRootTip",
        ...
        if (mainStemAux_std < 0.01) and (mainStemAux_mean > 1) and ( r.burnInTime):#(day4burnin <= 0) :
            ...
            r.auxin_threshold =mainStemAux_mean*0.5
            write_file_float("auxin_threshold", r.auxin_threshold)
            errorBU = error

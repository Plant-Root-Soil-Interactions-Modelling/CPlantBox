...
def runSim(directoryN_,doVTP, verbosebase,
           ...
           testTime, dtBefore, dtAfter, start_time, dt_write,
  ...
  "C_Auxin","AuxinSource","Delta_JA_ST","C_AuxinOut","JAuxin_ST2",
     "activePhloem","activeAuxin","Agn4Phloem","isRootTip",
        ...
        if( time.time() - dt_lastWrote) >= dt_write:
...
if __name__ == '__main__':
    ...
    runSim(directoryN_=directoryN,doVTP = False, verbosebase = False,
           PRate_ = 4, thresholdAux = 0.8, RatiothresholdAux =0.5,
           Qmax_ = 0, thresholdSuc = 0.8,
           useCWGr = False, UseRatiothresholdAux = True,
           activeAtThreshold_auxin = True,activeAtThreshold_suc = False,
            nodeD = 5, thread = 0,  testTime=7,start_time = start_time_,
          dtBefore = 1/24, dtAfter= 1/24, doPrint = False, doDict = True, 
          dt_write = 2, auxin_D=0.)
...
rho_org = [[0.1],[0.1],[0.1]]
rho_org = np.array([np.array(xi) for xi in rho_org])#*10
...
r.plant.node_Decapitate = np.array([org_.getNodeId(org_.getNumberOfNodes()-2), org_.getNodeId(org_.getNumberOfNodes()-1)])

...
def launchUQR(directoryN,simInit, condition):
    ...
    def weather(simDuration, hp):
        ...
        weatherVar = {'TairC' : TairC_,'TairK' : TairC_ + 273.15,'Pair':Pair,
                        'Qlight': Q_,'rbl':rbl,'rcanopy':rcanopy,'rair':rair,
    ...
    while simDuration < simMax: 
        ...
        try:
            ...
            print("startpm WITH troubleshoot", hp)
        ...
        ana.write("results"+directoryN+"15pm_"+ str(ö) +".vtp", 
                  ["organType", "subType",
                   "CST", "fluxes","psi_Xyl",
                   "QExud", "QGr", "QRm",
                   "CExud", "CGr", "CRm",

...
model.thresh13 = 1.e-10;  # threshold to neglect diffusing g (eqn 13)
model.calc13 = True;  # turns Eqn 13  on (True) and off (False)
model.observationRadius = 0.4;  # limits computational domain around roots [cm]
...
for r in range(0,len(numo)):
    ...
    max = 150 #maximum number of segments that should be processd in parallel 

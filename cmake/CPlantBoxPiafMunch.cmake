...
function(cpb_find_source_library output_variable display_name)
    ...
    if(WIN32)
        set(_static_archive_pattern "\\.(a|lib)$")
        set(_static_archive_label ".a or .lib")
    else()
        set(_static_archive_pattern "\\.a$")
        set(_static_archive_label ".a")
    endif()
    if(NOT _library_path MATCHES "${_static_archive_pattern}")
        message(FATAL_ERROR "Requested source-built ${display_name}, but expected a static ${_static_archive_label} archive and found: ${_library_path}")
    endif()
    set(${output_variable} "${_library_path}" PARENT_SCOPE)
    unset(_library_path CACHE)
endfunction()

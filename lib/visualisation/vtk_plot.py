...
def plot_plant(plant, p_name, render = True, interactiveImage = True, save_as =  "plot_plant"):
    """
    ...
    if render:
        ren = render_window([tube_plot_actor, actor], save_as, color_bar, tube_plot_actor.GetBounds(), interactiveImage)
        if interactiveImage:
            ren.Start()
